...
* add task issue template restricted to maintainers ([#51](https://github.com/FredrikFolkeryd/obsidian-pa/issues/51)) ([b78d95b](https://github.com/FredrikFolkeryd/obsidian-pa/commit/b78d95b8311f4d3514befdf5a3f514faac4ebbaa))
...
* **ci:** automate changelog and releases with release-please ([#58](https://github.com/FredrikFolkeryd/obsidian-pa/issues/58)) ([d216c33](https://github.com/FredrikFolkeryd/obsidian-pa/commit/d216c33211b3bebe4fda8786b410078c933248f3))
* **context-picker:** improve usability of context selector ([#43](https://github.com/FredrikFolkeryd/obsidian-pa/issues/43)) ([48a31b0](https://github.com/FredrikFolkeryd/obsidian-pa/commit/48a31b0dfb473bfcf5fef47e44e9528ccb7c1721))
...
* verify licence compatibility and add automated licence enforcement ([#57](https://github.com/FredrikFolkeryd/obsidian-pa/issues/57)) ([9d2efca](https://github.com/FredrikFolkeryd/obsidian-pa/commit/9d2efca52bbb818000f6f3a6086def3586ecb8fc))
...
* **chat:** always add newly opened files to context ([1513605](https://github.com/FredrikFolkeryd/obsidian-pa/commit/1513605eef56a03d4a18715b952e2e4d77e07418))
* **chat:** auto-update context on workspace changes ([3a851af](https://github.com/FredrikFolkeryd/obsidian-pa/commit/3a851af89c66f2632ab626436e7c6f5ea847f117))
* **chat:** auto-update context when workspace changes ([23019ca](https://github.com/FredrikFolkeryd/obsidian-pa/commit/23019ca19d93aaf72c3092b4bbbbe1cc1172fefe))
...
* **chat:** context files count not updating correctly ([#3](https://github.com/FredrikFolkeryd/obsidian-pa/issues/3)) ([0d101b7](https://github.com/FredrikFolkeryd/obsidian-pa/commit/0d101b702b48713ec555d8ca6cb81f93e23e7289))
...
* **chat:** maintain async onClose signature for compatibility ([9fcd6dd](https://github.com/FredrikFolkeryd/obsidian-pa/commit/9fcd6dd029f377ed45a2b12f6593abcc5cfd43eb))
* **chat:** model settings take effect immediately in open views ([#29](https://github.com/FredrikFolkeryd/obsidian-pa/issues/29)) ([e1777a8](https://github.com/FredrikFolkeryd/obsidian-pa/commit/e1777a811c87502e3202f989cb3ef3218a131d99))
...
* **chat:** restore input and show informative message when request interrupted by app switch ([#47](https://github.com/FredrikFolkeryd/obsidian-pa/issues/47)) ([e0bdc5d](https://github.com/FredrikFolkeryd/obsidian-pa/commit/e0bdc5d7eae581824c73382d1d4318f731eeed03))
* **chat:** use ISO 8601 timestamps instead of unreliable toLocaleString\n\nElectron's toLocaleString() uses en-US format regardless of system\nlocale settings. Replace all toLocaleString/toLocaleTimeString/\ntoLocaleDateString calls with explicit ISO 8601 formatting\n(YYYY-MM-DD HH:mm:ss) which is unambiguous and internationally\ncorrect.\n\n- Add formatDateTimeISO() and formatTimeISO() shared helpers\n- Update formatConversationExport to use ISO timestamps\n- Update formatRelativeTime fallback to use ISO format\n- Update TaskHistoryView.formatDate to use ISO format\n- Update TaskHistoryManager.formatHistoryEntry to use ISO format\n- Add 8 new tests for the ISO formatting helpers" ([d020073](https://github.com/FredrikFolkeryd/obsidian-pa/commit/d02007333f984fba9c157cb89ffccdf34313d136))
* **ci:** assign copilot directly instead of using triage label\n\nThe triage label workflow doesn't work on personal repos. Instead,\nassign the copilot user directly to the issue and mention [@copilot](https://github.com/copilot)\nin the comment to trigger triage.\n\n- Remove triage label step from issue-triage workflow\n- Add assignee step to assign copilot to the issue\n- Remove triage label reference from triage instructions" ([0babfbe](https://github.com/FredrikFolkeryd/obsidian-pa/commit/0babfbe71dee4d8fab15bba5647aa0aa7c02aa22))
* context selection updates when assistant panel is re-activated ([#41](https://github.com/FredrikFolkeryd/obsidian-pa/issues/41)) ([8a017f3](https://github.com/FredrikFolkeryd/obsidian-pa/commit/8a017f39c64efab7571e7554c7d8a54c8a870b93))
* **context:** context files not recognized when added via picker ([#48](https://github.com/FredrikFolkeryd/obsidian-pa/issues/48)) ([409c028](https://github.com/FredrikFolkeryd/obsidian-pa/commit/409c0288a6ed9aca956c16c4f4b63800ab52b225))
* correct property name from contextWindow to maxContextTokens in ChatView ([4d4e481](https://github.com/FredrikFolkeryd/obsidian-pa/commit/4d4e4812886a3615586aab2ecad7cd8382cc201f))
* correct TokenBudgetConfig property name in context file handling ([d0c8fff](https://github.com/FredrikFolkeryd/obsidian-pa/commit/d0c8fffa6ca110178506f1b147ee912722685558))
* create intermediate backup directories for nested file paths ([#37](https://github.com/FredrikFolkeryd/obsidian-pa/issues/37)) ([02491be](https://github.com/FredrikFolkeryd/obsidian-pa/commit/02491be6f05b59726dbba818e8b7770aeb0fbc7c)), closes [#36](https://github.com/FredrikFolkeryd/obsidian-pa/issues/36)
...
* edits truncated with nested code blocks and unactionable error messages ([#30](https://github.com/FredrikFolkeryd/obsidian-pa/issues/30)) ([71cff71](https://github.com/FredrikFolkeryd/obsidian-pa/commit/71cff718f7605ae25f2db092a4f03c7efa2011cc))
...
* ensure open files saved before edit operations to prevent stale content ([#22](https://github.com/FredrikFolkeryd/obsidian-pa/issues/22)) ([0463b7a](https://github.com/FredrikFolkeryd/obsidian-pa/commit/0463b7a007ae8a539653a12b3b486d96e9c098f9))
...
* settings auto-open on restart for configured plugins ([#27](https://github.com/FredrikFolkeryd/obsidian-pa/issues/27)) ([11d3e02](https://github.com/FredrikFolkeryd/obsidian-pa/commit/11d3e02d8e091223d885274e68e03e79cffccacc))
...
* standardise issue template label format and document template chooser flow ([#52](https://github.com/FredrikFolkeryd/obsidian-pa/issues/52)) ([fa67c19](https://github.com/FredrikFolkeryd/obsidian-pa/commit/fa67c19fdb8f936d5c803a0ad5d5939923f3e94b))
...
* **ui:** add missing CSS classes for context picker selected items ([#35](https://github.com/FredrikFolkeryd/obsidian-pa/issues/35)) ([50ba77e](https://github.com/FredrikFolkeryd/obsidian-pa/commit/50ba77ea3a87527a46fc80dce65db37fd2f4b784))
* **ui:** chat icon does not open chat panel ([#26](https://github.com/FredrikFolkeryd/obsidian-pa/issues/26)) ([5676e45](https://github.com/FredrikFolkeryd/obsidian-pa/commit/5676e456ae2ec45fced534ae8d2d699ded1cf70c))
...
* use consistent local time for timestamp + renovate ([790f97f](https://github.com/FredrikFolkeryd/obsidian-pa/commit/790f97fb4fc1ade863aadbd97792813a23544dae))
...
* add SECURITY.md for responsible vulnerability reporting ([#55](https://github.com/FredrikFolkeryd/obsidian-pa/issues/55)) ([dd8e9fe](https://github.com/FredrikFolkeryd/obsidian-pa/commit/dd8e9fe233c4e7eaf77fd75a0029b185d20dd1bb))
...
* simplify issue templates to reduce friction ([#32](https://github.com/FredrikFolkeryd/obsidian-pa/issues/32)) ([412cdd4](https://github.com/FredrikFolkeryd/obsidian-pa/commit/412cdd4bca605d41d4f7d3bcbc9106419c697a3b))
...
* **work:** finalize developer.md with complete implementation summary ([73f1433](https://github.com/FredrikFolkeryd/obsidian-pa/commit/73f14337c139c1c04500cbfc698138b8523cd98a))
...
* **work:** update developer.md with async onClose details ([16e3c1b](https://github.com/FredrikFolkeryd/obsidian-pa/commit/16e3c1bf0d92c258be8377ae725d7b77d648b3ac))
...
* **deps:** update actions/checkout action to v6 ([#12](https://github.com/FredrikFolkeryd/obsidian-pa/issues/12)) ([e7c3223](https://github.com/FredrikFolkeryd/obsidian-pa/commit/e7c3223c5bfac00ccd16a648737a8ea8657c0620))
* **deps:** update actions/github-script action to v8 ([#13](https://github.com/FredrikFolkeryd/obsidian-pa/issues/13)) ([aa93472](https://github.com/FredrikFolkeryd/obsidian-pa/commit/aa934728126242e397ad1c00d1b5dba6d8e51475))
* **deps:** update actions/setup-node action to v6 ([#15](https://github.com/FredrikFolkeryd/obsidian-pa/issues/15)) ([472afe3](https://github.com/FredrikFolkeryd/obsidian-pa/commit/472afe31fc42064394e1724b2014dbdeb28b7acc))
* **deps:** update dependency @types/node to v20.19.32 ([#9](https://github.com/FredrikFolkeryd/obsidian-pa/issues/9)) ([f6db4db](https://github.com/FredrikFolkeryd/obsidian-pa/commit/f6db4db209e1a41a5c86d981095acb5e49daea41))
* **deps:** update dependency @types/node to v20.19.33 ([#14](https://github.com/FredrikFolkeryd/obsidian-pa/issues/14)) ([c0e9445](https://github.com/FredrikFolkeryd/obsidian-pa/commit/c0e9445c775ff8993e74971ee0c10e5946bc75a0))
* **deps:** update dependency @types/node to v20.19.34 ([#39](https://github.com/FredrikFolkeryd/obsidian-pa/issues/39)) ([c3682f4](https://github.com/FredrikFolkeryd/obsidian-pa/commit/c3682f42829d4a864e2651fe3c6e49ede70393e3))
* **deps:** update dependency @types/node to v20.19.35 ([#44](https://github.com/FredrikFolkeryd/obsidian-pa/issues/44)) ([5d9a934](https://github.com/FredrikFolkeryd/obsidian-pa/commit/5d9a934c1b2250e6fd1fd4e3b1d1380c0d1cf5c7))
* **deps:** update dependency esbuild to ^0.27.0 ([#10](https://github.com/FredrikFolkeryd/obsidian-pa/issues/10)) ([8f39d33](https://github.com/FredrikFolkeryd/obsidian-pa/commit/8f39d33e6ab0a252d6be0e5a3159fc33ad03ed82))
* **deps:** update softprops/action-gh-release action to v2 ([#19](https://github.com/FredrikFolkeryd/obsidian-pa/issues/19)) ([fea60ec](https://github.com/FredrikFolkeryd/obsidian-pa/commit/fea60ec74adcba920d2cb1ef0aac076a9d73a562))
* **deps:** update typescript-eslint monorepo to v8.55.0 ([#23](https://github.com/FredrikFolkeryd/obsidian-pa/issues/23)) ([a197a67](https://github.com/FredrikFolkeryd/obsidian-pa/commit/a197a67a16cd50e104a6df0367e396d7320b43f3))
* **deps:** update typescript-eslint monorepo to v8.56.0 ([#33](https://github.com/FredrikFolkeryd/obsidian-pa/issues/33)) ([cda5c85](https://github.com/FredrikFolkeryd/obsidian-pa/commit/cda5c85c84c80bc7c9bcad3f9c69ddc4fae233b0))
* **deps:** update typescript-eslint monorepo to v8.56.1 ([#38](https://github.com/FredrikFolkeryd/obsidian-pa/issues/38)) ([26ba501](https://github.com/FredrikFolkeryd/obsidian-pa/commit/26ba501de704a0e908da68bbb824bdcbec854819))
...
* prepare for public beta release ([#49](https://github.com/FredrikFolkeryd/obsidian-pa/issues/49)) ([5ab352e](https://github.com/FredrikFolkeryd/obsidian-pa/commit/5ab352eb1281a0866c1f64f9c9e34927b7756993))
...
* **chat:** add debouncing to context refresh ([1abd816](https://github.com/FredrikFolkeryd/obsidian-pa/commit/1abd816a0cf427f57464e4d9eaf90c20b92ffdbc))
* **chat:** deduplicate timestamp formatting and use locale-correct dates\n\n- Replace duplicated formatTime() in EditHistoryModal with shared\n  formatRelativeTime() from helpers.ts\n- Replace duplicated inline export logic in ChatView with shared\n  formatConversationExport() from helpers.ts\n- Fix getTodayDateString() to use local date components instead of\n  UTC-based toISOString(), preventing usage counter reset at wrong\n  time near midnight\n- Replace inline toISOString date strings in ChatView with\n  getTodayDateString() calls\n- Update tests to use local timezone dates" ([7c88983](https://github.com/FredrikFolkeryd/obsidian-pa/commit/7c88983fb1687aa731b54c52fe2d51f0c7de040f))
